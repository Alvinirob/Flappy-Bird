...
background = pygame.image.load('File/background-day.png').convert()
background = pygame.transform.scale2x(background)

# floor image load
floor = pygame.image.load('File/floor.png').convert()
floor = pygame.transform.scale2x(floor)
floor_pos = 0

# bird image load
bird = pygame.image.load('File/bluebird-midflap.png').convert()
bird = pygame.transform.scale2x(bird)
bird_rect = bird.get_rect(center=(100, 450))  # create a rectangular outside the bird

# pipe image load
pipe_sur = pygame.image.load('File/pipe-green.png')
